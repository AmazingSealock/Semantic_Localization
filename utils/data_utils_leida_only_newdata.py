...
mask_root1 = "/home/xingzhaohu/point_cloud_project/data/mask_5k_png"
...
mask_root2 = "/home/xingzhaohu/point_cloud_project/data/2024_0405_data/labels"

all_mask_paths = glob.glob(f"{mask_root2}/*.png")
# split_pos = int(len(all_mask_paths) * 0.8)

# train_mask_paths.extend(all_mask_paths2)
test_mask_paths = all_mask_paths
